  ...
  useEffect(() => {
    ...
    const handleMessage = (event: MessageEvent) => {
      ...
      if (envelope.kind === "connection.status") {
        ...
        setState(value => ({ ...value, viewer: { adopted: Boolean(data.adopted), heroId: typeof data.heroId === "string" ? data.heroId : undefined, heroName: data.heroName, gold: typeof data.gold === "number" ? data.gold : undefined, prestige: data.prestige ?? undefined, battleBalance: data.battleBalance ?? undefined } }));
