...
Based on reviewed commit `a44ffb3171207649e7ce716041573584ac9a38da`, plus the deployed campaign/reconnect and personal-HUD/roster fixes. The exact submitted source is commit `c5c29481d1bb523ff6205474b0fb6315f24e2570`, preserved in the history of `BLT/twitch-integration`. Current branch development also includes prestige and battle-balance features absent from that submitted snapshot. Unrelated main/enchantment changes were excluded.
