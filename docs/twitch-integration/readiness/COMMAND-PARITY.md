...
|---|---|---|---:|---|---|---|
| `command.balance` | `!balance` | `BalanceCommand` | 0 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
| `command.prestige` | `!prestige` | `PrestigeCommand` | 2 | viewer, moderator, broadcaster | Mapped | Pending hosted game test |
